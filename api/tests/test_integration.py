...
class FullFlowIntegrationTest(APITestCase):
    ...
    def test_multiple_users_data_isolation(self, _):
        ...
        self.assertNotIn("User two reads breaking news about politics this week", titles_1)
        ...
        self.assertNotIn("User one reads breaking news about the economy today", titles_2)
